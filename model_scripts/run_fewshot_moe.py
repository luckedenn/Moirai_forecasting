...
def run_fewshot_moe(
    ...
    model = MoiraiMoEForecast(
        ...
        patch_size=16,
        num_samples=100,            # untuk uncertainty
        target_dim=1,
...
DATASETS = [
    {
        ...
        "pred_len": 30,      # 1 bulan
        "context_len": 365,  # 1 tahun konteks
        "freq": "D",
        "n_shots": 3,
    },
    {
        ...
        "pred_len": 20,      # ~1 bulan trading
        "context_len": 250,  # 1 tahun trading
        "freq": "D",         # Daily (lebih stabil dari business day)
        "n_shots": 3,
    },
    {
        ...
        "pred_len": 12,      # 1 tahun
        "context_len": 180,  # 15 tahun
        "freq": "M",         # akhir bulan (stabil untuk GluonTS)
        "n_shots": 3,
    },
]
