...
if MODEL == "moirai":
    ...
    model = Moirai2Forecast(
        ...
        prediction_length=PDT,              # gunakan PDT yang kamu set
        context_length=CTX,                 # gunakan CTX yang kamu set
        target_dim=1,
        # jika dataset kamu univariat, biarkan 0; kalau tidak, sesuaikan:
