...
if __name__ == "__main__":
    # Hyperparameter default yang ringan untuk laptop
    HP = {
        "epochs": 10,         # bisa naikkan ke 20–30 untuk akurasi lebih baik
        "batch_size": 128,
        "hidden_size": 64,
        "num_layers": 2,
        "lr": 1e-3,
    ...
    DATASETS = [
        ...
        ("weather_melbourne", "data/weather_melbourne/weather_melbourne_full.csv", "D", 24, 180),
        ("finance_aapl", "data/finance_aapl/finance_aapl_full.csv", "B", 24, 250),   # 1 tahun bursa sebagai konteks
        ("co2_maunaloa_monthly", "data/co2_maunaloa_monthly/co2_maunaloa_monthly_full.csv", "M", 12, 120),
    ]
